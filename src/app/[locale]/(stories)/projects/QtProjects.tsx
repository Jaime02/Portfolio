  ...
  return (
    <CardsLayout {...props} font={QtFont.className} ref={ref}>
      ...
      <Card>
        ...
        <Image
          src="/images/TechnicalDrawingAppScreenshot.webp"
          width="700"
          height="700"
          alt={t("Technical drawing app")}
      ...
      <Card>
        ...
        <p>{t("4.3")}</p>
        <Image
          src="/images/GeneticAlgorithms.webp"
          width="800"
          height="800"
          alt={t("Genetic algorithms")}
          className="w-full select-none"
          draggable="false"
          priority={true}
        />
      ...
      <Card>
        ...
        <Image
          ...
          height="800"
          alt="QKNNPainter"
          className="mx-auto w-[60%] select-none"
          draggable="false"
          priority={true}
        />
