  ...
  return (
    <CardsLayout {...props} ref={ref}>
      <Card>
        ...
        <p>
          This is a simple project I developed for a university subject in order to test{" "}
          <a className="styled-a" target="_blank" href="https://www.opengl.org/">
            OpenGL
          </a>{" "}
          shaders in real time. The user can edit the fragment and vertex shaders source code and the program will recompile and execute them on demand. It is written in ancient Java.
        </p>
