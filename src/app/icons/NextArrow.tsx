export default function NextArrow({ extraClasses, onClick }: { extraClasses?: string; onClick?: () => void }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" aria-label="Next" className={`${extraClasses}`} fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onClick={onClick}>
      <title>Next</title>
