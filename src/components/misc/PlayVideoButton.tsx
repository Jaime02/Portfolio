...
export default function PlayVideoButton() {
  ...
  return (
    <button
      className={`absolute top-1/2 left-1/2 z-10 -translate-x-1/2 -translate-y-1/2 ${hasEverPlayedStories ? "hidden" : "block"} rounded-full p-2 transition-opacity duration-300 hover:scale-110`}
