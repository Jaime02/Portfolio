...
export default function CloseFriends() {
  ...
  return (
    <div
      ...
      className="bg-ig-close-friends flex items-center justify-center rounded-md p-2 text-white"
    >
      ...
      <p
        className={`overflow-hidden transition-all duration-300 ease-in-out ${isHovered ? "ml-1 sm:w-auto sm:translate-x-0 sm:opacity-100" : "w-0 -translate-x-2 opacity-0"} text-xs font-semibold whitespace-nowrap`}
      >
        {t("Close friends")}
      </p>
    </div>
