export default function BestFriends() {
  return (
    <div className="bg-ig-close-friends p-2 flex gap-1 items-center justify-center rounded-md">
      <svg aria-label="Close friends" className="size-3" fill="currentColor" viewBox="0 0 24 24">
      ...
      <p className="hidden sm:block text-xs font-semibold">Close friends</p>
    </div>
  );
}
